...
ActiveRecord::Schema.define(version: 20160506094209) do
  ...
  create_table "al_alliances", force: :cascade do |t|
  ...
  add_index "al_alliances", ["g_game_board_player_id", "h_house_id", "h_peer_house_id"], name: "al_alliances_unique_index", unique: true, using: :btree
  ...
  create_table "al_enemies", force: :cascade do |t|
    t.integer  "g_game_board_player_id", null: false
    t.integer  "h_house_id",             null: false
    t.integer  "h_enemy_house_id",       null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "al_enemies", ["h_house_id", "h_enemy_house_id"], name: "al_enemies_unique_index", unique: true, using: :btree
  ...
  add_foreign_key "al_alliances", "g_game_board_players"
  add_foreign_key "al_alliances", "h_houses"
  ...
  add_foreign_key "al_enemies", "g_game_board_players"
  add_foreign_key "al_enemies", "h_houses"
